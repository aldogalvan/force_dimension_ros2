...
namespace force_dimension {
  ...
  class Node : public rclcpp::Node {
   ...
   private:
    ...
    // Publishes robot orientation messages
    ...
    void SubscribeForceAndTorqueAndGripperForce(void);
    

    // Applies a force to the robotic manipulandum, as requested via ROS 
    // message.
    void force_callback(const ForceMessage::SharedPtr);
    void torque_callback(const TorqueMessage::SharedPtr);
    void gripper_force_callback(const GripperForceMessage::SharedPtr);
    void set_force_and_torque_and_gripper_force(void);
   ...
   private:
    ...
    rclcpp::Subscription<GripperForceMessage>::SharedPtr gripper_force_subscription_;
    rclcpp::TimerBase::SharedPtr robot_command_timer_;
    ForceMessage::SharedPtr last_force_msg_ = nullptr;
    TorqueMessage::SharedPtr last_torque_msg_ = nullptr;
    GripperForceMessage::SharedPtr last_gripper_force_msg_ = nullptr;

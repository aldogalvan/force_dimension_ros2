...
*  
*/
  typedef geometry_msgs::msg::Quaternion OrientationMessage;
   ...
   *  
   */
  typedef geometry_msgs::msg::Vector3 AngularVelocityMessage;
   ...
   *  
   */
  typedef geometry_msgs::msg::Vector3 TorqueMessage;
